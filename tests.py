...
class TestBooksCollector:
    ...
    def test_add_book_in_favorites_add_one_books_in_favorites(self):
        books_collector = BooksCollector()
        ...
        assert (len(books_collector.get_list_of_favorites_books()) == 1 and
                books_collector.get_list_of_favorites_books()[0] == "Book2")
